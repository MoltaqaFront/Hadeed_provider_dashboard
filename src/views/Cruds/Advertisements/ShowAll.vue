  ...
  <div class="show_all_content_wrapper">
    ...
    <main>
      ...
      <div class="table_title_wrapper">
        ...
        <div class="title_route_wrapper" v-if="$can('ad_spaces create', 'ad_spaces')">
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            <a-tooltip placement="bottom" v-if="$can('ad_spaces show', 'ad_spaces')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('ad_spaces edit', 'ad_spaces')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('ad_spaces delete', 'ad_spaces')">
              <template slot="title">
